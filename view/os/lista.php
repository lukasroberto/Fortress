...
<div class="container"> 
  ...
  <form class="form-inline" role="form" id="relatorio-form" action="lista.php" method="get">
    ...
    <table class="table table-condensed table-hover table-striped">
      <thead>
        <tr>
          <th><div><strong>Cod. OS</strong></div></th>
          <th><div><strong>Cliente</strong></div></th>
          <th><div><strong>Aberta em</strong></div></th>
          <th><div><strong>Solicitada por</strong></div></th>
          <th><div style="text-align:center"><strong>Status</strong></div></th>
      </thead>
        </tr>
