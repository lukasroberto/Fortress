...
?>
        ...
        <blockquote>
        <h2>Relatórios de Serviços finalizados</h2>
        <small>Utilize os filtros para conferir a quantidade de serviços realizados por cada colaborador.</small> 
        </blockquote>
        ...
        <thead>
        <tr>
        <th class="iconorder"><b>Técnico</b></th>
        <th class="iconorder"><b>QTD de OS</b></th>
        <th class="iconorder"><b>Média por dia</b></th>
        </tr>
        </thead>
        <?php 
        $totalQuantidadeOS ='';
