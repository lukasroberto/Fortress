                ...
                <th class="iconorder">Login</th>
                <th class="iconorder">Tipo de Usuário</th>
                <th class="iconorder">Acesso ao Sistema</th>
                ...
                <td><?php echo $tipo; ?></td>
                <td><?php echo ($reg["log_acesso_sistema"] == 0 ) ? '<div style="color:#C00">Não</div>' : '<div style="color:#0C0">Sim</div>' ; ?></td>
                <td style="text-align:center"><a type="button" title="Editar" href="edita.php?idusuario=<?php echo $reg["log_id"]; ?>"><i class="glyphicon glyphicon-pencil"></i></a></td>
                <td style="text-align:center"><a type="button" title="Excluir" class="vermelho-excluir" href="lista.php?idusuario=<?php echo $reg["log_id"]; ?>"><i class="glyphicon glyphicon-trash"></i></a></td>
                </tr>
                <?php
                }
                ?>
